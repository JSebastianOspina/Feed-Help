...
@section('contenido')
    ...
    <div class="text-center">
        ...
        <a type="button" href='{{url("enableDeck/{$id}")}}' class="btn btn-success btn-rounded mb-3 text-white"><i
                class="fas fa-user-plus"></i> Activar Deck</a>

        <a type="button" href='{{url("disableDeck/{$id}")}}' class="btn btn-danger text-white btn-rounded mb-3"><i
                class="fas fa-user-plus"></i> Desactivar Deck </a>

        <button type="button" class="btn btn-secondary btn-rounded mb-3 " data-toggle="modal" data-target="#editarmodal"><i
                class="fas fa-pencil-alt"></i> Editar Deck</button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <center>
                            ...
                            <form class="form-group" method="POST" target="_blank" action="{{ route('generar') }}">
                                @csrf
                            ...
                            <form class="form-group" target="_blank" method="POST" action="{{ route('generar1') }}">
                                @csrf
                            ...
                            @if ($cred->api3key != null)
                                ...
                                <form class="form-group" target="_blank" method="POST" action="{{ route('generar3') }}">
                                    @csrf
                            ...
                            @if ($cred->api3key != null)
                                <p>Si deseas reautorizar, da clic al botón, se abrirá una ventana y se cerrará
                                    automáticamente.
                                    Luego de esto, puedes volver a autorizar las apis dando clic a los botones "Api1",
                                    "Api2" y "Api3"</p>
                            @else
                                <p>Si deseas reautorizar, da clic al botón, se abrirá una ventana y se cerrará
                                    automáticamente.
                                    Luego de esto, puedes volver a autorizar las apis dando clic a los botones "Api1" y
                                    "Api2"</p>
                            @endif
                        </center>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form class="form-group" method="POST" action="{{ route('decks.destroy', ['deck' => $id]) }}">
                            @csrf
                            @method('DELETE')
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form class="form-group" method="POST" action="{{ route('nuevouser', ['id' => $id]) }}">
                            @csrf
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form class="form-group" method="POST" action="{{ route('nuevoadmin', ['id' => $id]) }}">
                            @csrf
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form class="form-group" method="POST" action="{{ route('decks.update', ['deck' => $id]) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <label class="form-control-label" for="key1">Key✍️</label>
                            ...
                            <label class="form-control-label" for="key2">Key 2✍️</label>
                            ...
                            <label class="form-control-label" for="key3">Key 3     (ELIMINAR TWEETS)🗑️🗑️</label>
                ...
                <tbody>
                    @foreach ($decks as $deck)
                        <tr>
                            ...
                            @elseif (in_array($deck->username,$vips))
                                <td>{{ $deck->username }} <strong>VIP ✨</strong></td>
                            ...
                            <td>
                                <form action="{{ route('eliminar-user') }}" method="post">
                                    ...
                                    <input type="text" name="username" value="{{ $deck->username }}"
                                        style="display:none">
