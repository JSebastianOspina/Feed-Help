...
<div class="text-right">
    <button type="button" class="btn btn-success btn-rounded mb-3 " data-toggle="modal"
        ...
        data-target="#darrt"><i class="fas fa-check"></i>M A S T E R - R T</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form-group" method="POST" action="{{ route('master') }}">
                    ...
                    <select class="form-select form-control" size="10" multiple aria-label="multiple select example" id="deck_list" name="deck_list[]">
                      ...
                      <select class="form-select form-control" aria-label="multiple select example" id="delete" name="delete">
...
<div class="table-responsive">
    <table class="table">
        ...
        @foreach($decks as $deck)
            <tr>
                <td><a href="/decks/{{str_replace(' ','_',$deck['nombre'])}}">{{$deck['nombre']}}</a></td>
                <td>{{$deck['admin']}}</td>
