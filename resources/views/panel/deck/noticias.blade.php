...
<body>
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed" data-boxed-layout="full">
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link" href="{{route('decks.index')}}"
                                aria-expanded="false"><i class="fab fa-twitter"></i><span
                                 ...
                                 <li class="list-divider"></li>
                        <li class="nav-small-cap"><span class="hide-menu">Ayuda</span></li>
                                
                                <li class="sidebar-item"> <a class="sidebar-link" href="https://www.youtube.com/watch?v=c2AVToUsueQ&list=PLqqJaSpZE-1aV8UisRmzliJOx_LonLpZ3"
                                aria-expanded="false"><i class="fab icon-control-play"></i><span
                                    class="hide-menu">Video Tutoriales
                                </span></a>
                                 <li class="sidebar-item"> <a class="sidebar-link" href="https://shadowban.eu/"
                                aria-expanded="false"><i class="fas fa-ban"></i><span
                                    class="hide-menu">BAN CHECK
                                </span></a>
                                 <li class="list-divider"></li>
                        <li class="nav-small-cap"><span class="hide-menu">TIENDA</span></li>
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                                aria-expanded="false"><i data-feather="file-text" class="far fa-money-bill-alt"></i><span
                                    class="hide-menu">TIENDA </span></a>
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                <li class="sidebar-item"><a href="#" class="sidebar-link"><span
                                            class="hide-menu"> COMPRAR RTS
                                        </span></a>
                                </li>
                                <li class="sidebar-item"><a href="#" class="sidebar-link"><span
                                            class="hide-menu"> COMPRAR CUENTAS
                                        </span></a>
                                </li>
                                <li class="sidebar-item"><a href="#" class="sidebar-link"><span
                                            class="hide-menu"> Acceso 𝐕𝐈𝐏 
                                        </span></a>
                                </li>
                            </ul>
                        </li>
        ...
        <a target="_blank" class="btn btn-success btn-rounded mb-3 " href="{{route('mantenimiento',['estado'=>'activo'])}}" ><i class="fas fa-bolt"></i> Activar Deck</a>

        <a target="_blank" class="btn btn-warning btn-rounded mb-3 " href="{{route('mantenimiento',['estado'=>'mantenimiento','rango'=>'Admin'])}}" ><i class="fas fa-bolt"></i> Desactivar (Admins admitidos)</a>

        <a target="_blank" class="btn btn-danger btn-rounded mb-3 " href="{{route('mantenimiento',['estado'=>'mantenimiento'])}}" ><i class="fas fa-bolt"></i> Desactivar (PARA TODOS) </a>
                </div>
